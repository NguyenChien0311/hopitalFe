...
const sildes = [
  "https://theembazaar.com/demo/themesfolios/medical-care/assets/images/banner/slide-2.jpg",
  "https://theembazaar.com/demo/themesfolios/medical-care/assets/images/banner/img3.jpg",
  "https://theembazaar.com/demo/themesfolios/medical-care/assets/images/banner/img2.jpg",
];
          ...
          <div className="grid justify-items-center mt-5">
            <div className="py-20">
              ...
              <div className="flex px-2 pt-10 whitespace-nowrap">
                <CardInfo
                  image="https://theembazaar.com/demo/themesfolios/medical-care/assets/images/team-1.jpg"
                  name="Kevin Peterson"
                  position="Doctor"
                />
                <CardInfo
                  image="https://theembazaar.com/demo/themesfolios/medical-care/assets/images/team-2.jpg"
                  name="Kevin Peterson"
                  position="Doctor"
                />
                <CardInfo
                  image="https://theembazaar.com/demo/themesfolios/medical-care/assets/images/team-3.jpg"
                  name="Kevin Trap"
                  position="Doctor"
                />
                <CardInfo
                  image="https://theembazaar.com/demo/themesfolios/medical-care/assets/images/team-4.jpg"
                  name="Toaii"
                  position="Doctor"
                />
              </div>
